...
public class UpdateUserDtoValidatorTests
{
	...
	[Fact]
	public void FirstName_WhenNull_ShouldHaveValidationError()
	{
	...
	[InlineData("Studentik Studentovych")]
	[InlineData("Студентік Студентович")]
	public void FirstName_WhenContainsInvalidCharacters_ShouldHaveValidationError(string firstName)
	{
	...
	[Fact]
	public void LastName_WhenNull_ShouldHaveValidationError()
	{
	...
	[InlineData("Studentovych Studentovych")]
	[InlineData("Студентович Студентович")]
	public void LastName_WhenContainsInvalidCharacters_ShouldHaveValidationError(string lastName)
	{
	...
	[Fact]
	public void Phone_WhenEmpty_ShouldNotHaveValidationError()
	{
		var model = new UpdateUserDto
		{
			FirstName = "Studentik",
	...
	[InlineData("555-123-4567")]
	public void Phone_WhenInvalidFormat_ShouldHaveValidationError(string phone)
	{
	...
	[Fact]
	public void Validate_WhenAllFieldsValidWithoutPhone_ShouldNotHaveAnyValidationErrors()
	{
		var model = new UpdateUserDto
		{
			FirstName = "Studentik",
