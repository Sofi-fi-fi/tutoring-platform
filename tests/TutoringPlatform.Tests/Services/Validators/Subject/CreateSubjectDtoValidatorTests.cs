...
public class CreateSubjectDtoValidatorTests
{
	private readonly CreateSubjectDtoValidator _validator;

	public CreateSubjectDtoValidatorTests()
	{
		_validator = new CreateSubjectDtoValidator();
	}
	...
	{
		var model = new CreateSubjectDto { Name = string.Empty };
	...
	{
		var model = new CreateSubjectDto { Name = null! };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Name);
	}
	...
	{
		var model = new CreateSubjectDto { Name = new string('a', 101) };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Name)
	...
	{
		var model = new CreateSubjectDto { Category = string.Empty };
		var result = _validator.TestValidate(model);
	...
	{
		var model = new CreateSubjectDto { Category = null! };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Category);
	}
	...
	{
		var model = new CreateSubjectDto { Category = new string('a', 101) };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Category)
