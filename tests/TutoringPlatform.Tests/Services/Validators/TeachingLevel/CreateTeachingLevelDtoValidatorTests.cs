...
public class CreateTeachingLevelDtoValidatorTests
{
	private readonly CreateTeachingLevelDtoValidator _validator;

	public CreateTeachingLevelDtoValidatorTests()
	{
		_validator = new CreateTeachingLevelDtoValidator();
	}
	...
	{
		var model = new CreateTeachingLevelDto { Name = string.Empty };
	...
	{
		var model = new CreateTeachingLevelDto { Name = null! };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Name);
	}
	...
	{
		var model = new CreateTeachingLevelDto { Name = new string('a', 101) };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Name)
	...
	{
		var model = new CreateTeachingLevelDto { Name = name };
		var result = _validator.TestValidate(model);
		result.ShouldHaveValidationErrorFor(x => x.Name)
	...
	{
		var model = new CreateTeachingLevelDto
		{
			Name = name,
			Position = 1
		};
